...
% parameters are fre
    ...
    CoeffUpperBnd.p=repmat(1,k-1,k); % Fixed (value k-1 for new algorithm)
    CoeffLowerBnd.p=repmat(0,k-1,k);
...
[Coeff_Tag,uB]=spec2param(CoeffUpperBnd);   % converting upper bound to vector notation
[Coeff_Tag,lB]=spec2param(CoeffLowerBnd);   % converting lower bound to vector notation
