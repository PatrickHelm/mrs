...
suboptimal_decision_vector_R1=xlsread('Stochastic_Regimes_MR-MO.xlsx',1,'B4:B8');
suboptimal_decision_vector_R2=xlsread('Stochastic_Regimes_MR-MO.xlsx',1,'C4:C8');
suboptimal_decision_matrix_CEC=xlsread('Stochastic_Regimes_MR-MO.xlsx',1,'F4:J8');
