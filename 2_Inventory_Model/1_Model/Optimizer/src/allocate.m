% ALLOCATE(variables): Assign the values from the struct variable to the variables

function [ch, cp, d_max, I_max, k, m, pi, P_pr_reg, t_max, prices, normal_mu, normal_sigma,poisson_lambda,nbin_r,nbin_p] = allocate(variables)

%suboptimal_decision=variables.suboptimal_decision];
